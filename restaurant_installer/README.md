...
1. أنشئ قاعدة بيانات باسم `pos` في phpMyAdmin / MySQL (مستخدم `root`).
...
**ملاحظة:** الإصدار 1.0.2 — قاعدة البيانات خارجية (XAMPP). عند التحديث ثبّت فوق النسخة الحالية بدون إلغاء تثبيت. المثبّت يوقف LiteRestaurant / RestaurantPOS / PrintServer تلقائياً قبل استبدال الملفات.
