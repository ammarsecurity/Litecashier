...
**ملاحظة:** الإصدار 1.0.0 — قاعدة البيانات خارجية (XAMPP). عند التحديث ثبّت فوق النسخة الحالية بدون إلغاء تثبيت. المثبّت يوقف LiteRestaurant / RestaurantPOS / PrintServer تلقائياً قبل استبدال الملفات.
