...
begin
  Path := ExpandConstant('{app}\RestaurantPOS\appsettings.Production.json');
...
begin
  DbPage := CreateInputQueryPage(wpSelectDir,
    ...
    'تأكد أن خدمة MySQL (مثلاً من XAMPP) تعمل قبل تشغيل LiteRestaurant.');
