...
internal static class ServiceManager
{
    ...
    public static async Task EnsureRunningAsync(Action<string> setStatus)
    {
        ...
        WriteStartupLog("Database is external/manual (see RestaurantPOS\\appsettings.Production.json). Launcher will not start MySQL/MariaDB.");
    ...
    public static string BuildErrorMessage(Exception ex)
    {
        ...
        builder.AppendLine(Path.Combine(InstallDir, "RestaurantPOS", "appsettings.Production.json"));
