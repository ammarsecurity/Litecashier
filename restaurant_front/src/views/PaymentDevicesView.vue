  ...
  methods: {
    ...
    async saveDevice() {
      ...
      try {
        ...
        this.$toast.success(this.$t("savedSuccessfully") || "تم الحفظ");
      } catch (e) {
        console.error(e);
        this.$toast.error(e?.response?.data?.message || this.$t("saveFailed") || "فشل الحفظ");
      } finally {
        this.saving = false;
      }
    },
    ...
    async executeDelete() {
      ...
      try {
        ...
        await this.loadDevices();
        this.$toast.success(this.$t("deletedSuccessfully") || "تم الحذف");
      } catch (e) {
        this.$toast.error(this.$t("deleteFailed") || "فشل الحذف");
      } finally {
        this.deleting = false;
      }
    },
    ...
    async checkStatus(device, options = {}) {
      ...
      try {
        ...
        if (!silent) {
          this.$toast.error(this.$t("connectionFailed") || "فشل الاتصال");
        }
      } finally {
        if (!silent) {
          this.busyId = null;
    ...
    async connectDevice(device) {
      ...
      try {
        ...
        if (success) {
          this.$toast.success(this.$t("connectDeviceSuccess") || "تم الاتصال بالجهاز");
        } else {
          this.$toast.warning(res?.data?.message || this.$t("connectionFailed"));
        }
      } catch (e) {
        this.$toast.error(e?.response?.data?.message || this.$t("connectionFailed"));
      } finally {
        this.busyId = null;
        this.busyAction = null;
      }
    ...
    async cancelTrans(device) {
      ...
      try {
        ...
        this.$toast.info(this.$t("cancelSent") || "تم إرسال الإلغاء");
      } catch (e) {
        this.$toast.error(this.$t("cancelFailed") || "فشل الإلغاء");
      } finally {
        this.busyId = null;
        this.busyAction = null;
      }
