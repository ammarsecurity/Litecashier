            ...
            [FromQuery] int pageSize = 50)
        {
            ...
            var rows = await query
                ...
                .Select(t => new
                {
                    ...
                    DailySequenceNumber = t.CustomerOrder != null ? t.CustomerOrder.DailySequenceNumber : null,
        ...
        public async Task<ActionResult<GlobalResponse<object>>> RecheckSingle(int id)
        {
            ...
            return Ok(new GlobalResponse<object>
            {
                Data = new
                {
                    ...
                    dailySequenceNumber = tx.CustomerOrder?.DailySequenceNumber,
                    changed
                },
                ErrorStatus = false,
