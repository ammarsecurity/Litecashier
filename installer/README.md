...
**ملاحظة:** الإصدار 1.0.15 — قاعدة البيانات خارجية (XAMPP). عند التحديث ثبّت فوق النسخة الحالية بدون إلغاء تثبيت. المثبّت يوقف Litecashier / POS / PrintServer تلقائياً قبل استبدال الملفات.
