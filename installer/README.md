...
**ملاحظة:** الإصدار 1.0.33 — آمن للتحديث فوق التثبيت الحالي: يحفظ إعدادات MySQL وصور المنتجات والترخيص، ولا يمس قاعدة البيانات. يشمل صلاحية الأصناف وتقرير قرب الانتهاء وإصلاح فلاتر التقارير. لا تلغِ التثبيت قبل التحديث.
...
**v1.0.33+** — صلاحية اختيارية للأصناف + تقرير قرب/انتهاء الصلاحية (فلتر بالأيام) + استيراد Excel للتاريخ.

**v1.0.32+** — إصلاح فلاتر وباجينيشن تقارير الفواتير (بدون فقدان بيانات عند التحديث).

**v1.0.31+** — إصلاح ترتيب هيدر السلة والمخزن مع الشعار، وإزالة حالة السلة الفارغة.

**v1.0.30+** — مظهر نقطة البيع (شعار السلة وصورة المنتج الافتراضية) وعناصر مختصرة. التحديث فوق 1.0.29 أو أقدم لا يمسح الصور ولا إعدادات MySQL؛ الأعمدة الجديدة تُضاف تلقائياً عند أول تشغيل.
