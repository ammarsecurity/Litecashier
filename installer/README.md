...
**ملاحظة:** الإصدار 1.0.12 — قاعدة البيانات خارجية (XAMPP). عند التحديث ثبّت فوق النسخة الحالية بدون إلغاء تثبيت.
...
1. شغّل **إيقاف Litecashier** (أيقونة سطح المكتب أو الملف `Stop-Litecashier.bat`) لإغلاق النظام.
