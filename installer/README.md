...
**ملاحظة:** الإصدار 1.0.35 — آمن للتحديث فوق التثبيت الحالي: يحفظ إعدادات MySQL وصور المنتجات، ولا يمس قاعدة البيانات. الترخيص عبر الإنترنت مُعطّل. لا تلغِ التثبيت قبل التحديث.

**الترخيص:** مُعطّل افتراضياً (`License:Enabled: false`) — النظام يعمل بدون كود تفعيل ودون اتصال بسيرفر التراخيص.
