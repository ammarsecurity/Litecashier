...
**ملاحظة:** الإصدار 1.0.32 — آمن للتحديث فوق التثبيت الحالي: يحفظ إعدادات MySQL وصور المنتجات والترخيص، ولا يمس قاعدة البيانات. يطبّق migrations الجديدة فقط عند التشغيل. يشمل إصلاح فلاتر وباجينيشن التقارير. لا تلغِ التثبيت قبل التحديث.
