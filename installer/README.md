...
3. انسخ `Litecashier-Setup.exe` وثبّته.
...
**ملاحظة:** الإصدار 1.0.18 — قاعدة البيانات خارجية (XAMPP). عند التحديث ثبّت فوق النسخة الحالية بدون إلغاء تثبيت. المثبّت يوقف Litecashier / POS / PrintServer تلقائياً قبل استبدال الملفات.
