...
**ملاحظة:** الإصدار 1.0.20 — أثناء التثبيت تُطلب بيانات MySQL (Host / User / Password / Database). النظام ينشئ القاعدة إن لم تكن موجودة أو يحدّثها إن وُجدت. عند التحديث ثبّت فوق النسخة الحالية بدون إلغاء تثبيت. المثبّت يوقف Litecashier / POS / PrintServer تلقائياً قبل استبدال الملفات.
