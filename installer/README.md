...
**ملاحظة:** الإصدار 1.0.27 — آمن للتحديث فوق التثبيت الحالي: يحفظ إعدادات MySQL وصور المنتجات والترخيص، ولا يمس قاعدة البيانات. يطبّق migrations الجديدة فقط عند التشغيل. لا تلغِ التثبيت قبل التحديث.
