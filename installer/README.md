...
**ملاحظة:** الإصدار 1.0.31 — آمن للتحديث فوق التثبيت الحالي: يحفظ إعدادات MySQL وصور المنتجات والترخيص، ولا يمس قاعدة البيانات. يطبّق migrations الجديدة فقط عند التشغيل (عناصر مختصرة + مظهر نقطة البيع). روابط الصور تُبنى من نفس السيرفر حتى لا تنكسر بعد التحديث. لا تلغِ التثبيت قبل التحديث.
